  ...
  const addTask = useCallback(
    async (data: { title: string; notes?: string; priority?: Priority; category?: string; dueDate?: string | null; reminderAt?: string | null }) => {
      ...
      const newTask: Task = {
        ...
        reminderAt: (data.reminderAt && !isNaN(new Date(data.reminderAt).getTime())) ? data.reminderAt : null,
        reminderSent: !(data.reminderAt && !isNaN(new Date(data.reminderAt).getTime())),
        subtasks: [],
        createdAt: now,
        updatedAt: now,
      };
